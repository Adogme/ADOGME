			...
			<?php echo $this->tag->form(array('cuenta/registrarMascota', 'id' => 'registroMascotaForm', 'method' => 'post')); ?>
				...
				<div class="form-group col-md-3">
					<div class="input-group">
						<?php echo $form->render('peso', array('class' => 'form-control', 'aria-describedby' => 'basic-addon1')); ?>
				...
				<div class="form-group col-md-3">
					<div class="input-group">
						<?php echo $form->render('meses', array('class' => 'form-control', 'min' => '0', 'max' => '11')); ?>
					</div>
				</div>
				...
				<div class="form-group form-inline">
					Tamaño de pelo:
					<?php echo $form->render('small', array('class' => 'form-control')); ?> <?php echo $form->label('small'); ?>
					<?php echo $form->render('medium', array('class' => 'form-control')); ?> <?php echo $form->label('medium'); ?>
					<?php echo $form->render('large', array('class' => 'form-control')); ?> <?php echo $form->label('large'); ?>
				</div>

				<div class="form-group form-inline">
					Vacunas: <br>
					<?php echo $form->render('rabia', array('class' => 'form-control')); ?> <?php echo $form->label('rabia'); ?> <br>
					<?php echo $form->render('rabia', array('class' => 'form-control')); ?> <?php echo $form->label('distemper'); ?> <br>
					<?php echo $form->render('rabia', array('class' => 'form-control')); ?> <?php echo $form->label('polivalente'); ?>
				</div>

				<div class="form-group form-inline">
					Sexo:  
					<?php echo $form->render('macho', array('class' => 'form-control')); ?> <?php echo $form->label('macho'); ?>
					<?php echo $form->render('hembra', array('class' => 'form-control')); ?> <?php echo $form->label('hembra'); ?>
				</div>
